...
/*
    In order to parse an SVG file and get the vertices, use the parser class to
    read the data.  However, since the path_renderer class declares the path_storage
    object as private, it is necessary to rewrite this, as well as the parser in
    order to gain access to the path_storage object, which can then be used to gain
    access to the vertex information.
*/

#ifndef agg_svg_parser_templ_H_
#define agg_svg_parser_templ_H_
...
*/
    ...
    public:
        ...
        {
            parser_templ< pathT >& self = *(parser_templ< pathT >*)data;
